...
def EnumerateSubgraphsSequentially(input_filename, k, community_based = False):
    ...
    print ('Enumerated subgraphs in {:0.2f} seconds'.format(time.time() - start_time))



def EnumerateSubgraphsFromNodes(input_filename, k, nodes, output_suffix, community_based = False):
    """
